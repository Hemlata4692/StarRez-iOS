...
//    _parcelStatusBackGroundView.frame = CGRectMake(_parcelStatusBackGroundView.frame.origin.x, (_mainBackgroundView.frame.size.height+_mainBackgroundView.frame.origin.y)-49, self.view.frame.size.width-23, _parcelStatusBackGroundView.frame.size.height);
...
//    _parcelStatusBackGroundView.layer.mask = maskLayer;
    ...
    [path addLineToPoint:CGPointMake(_parcelTitle.frame.size.width, _parcelTitle.frame.size.height)];// add yourEndPoint here
